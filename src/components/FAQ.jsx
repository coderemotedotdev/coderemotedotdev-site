...
const FAQData = [
  {
    question: "How much will CodeRemote speed up my builds?",
    answer:
      <p>
        <b>Short answer:</b><br/>
  ...
  {
    question: "How does CodeRemote compare to GitHub Codespaces or Gitpod?",
    answer:
      <div>
    ...
    >
      <div className="relative z-10 container px-2 sm:px-8 lg:px-4 mx-auto w-11/12 sm:w-full">
        <div className="md:max-w-4xl mx-auto">
          <div className="mb-7 custom-block-subtitle text-center">
            Have any questions?
          </div>
          ...
          <div className="mb-11 flex flex-wrap -m-1">
            {FAQData.map((item, index) => (
              <div className="w-full p-1" key={`${item.question}`}>
                <FAQBox
                  title={item.question}
                  content={item.answer}
                  key={`${item.question}`}
